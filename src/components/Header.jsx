...
const Header = () =>(
  ...
  <header className="header">
    ...
    <div class="menu-header__navigation-margin" aria-hidden="true" role="presentation"></div>
    <a class="menu-header__navigation-item" href="/discover"><div class="menu-header__navigation-item-content">Riders</div></a>
    <div class="menu-header__navigation-gutter" aria-hidden="true" role="presentation"></div>
    <a class="menu-header__navigation-item menu-header__navigation-item--active" href="/events"><div class="menu-header__navigation-item-content">Eventos</div></a>
    <div class="menu-header__navigation-gutter" aria-hidden="true" role="presentation"></div>
    <a class="menu-header__navigation-item menu-header__navigation-item--active" href="/athletes"><div class="menu-header__navigation-item-content">Contenido</div></a>
    <div class="menu-header__navigation-gutter" aria-hidden="true" role="presentation"></div>
    <a class="menu-header__navigation-item" href="https://www.redbull.com/energydrink"><div class="menu-header__navigation-item-content">Productos</div></a>
    <div class="menu-header__navigation-margin" aria-hidden="true" role="presentation"></div>   
    </nav>

   <div class="menu-header__buttons">
     <button class="menu-header__button">
       <div class="menu-header__button-icon" aria-label="Buscar">
        ...
        <div class="menu-header__button">
          <button class="user-icon">
            <div class="user-icon__login-icon menu-header__button-icon" aria-label="Iniciar sesión">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
      ...
      <button class="menu-header__button">
        <div class="menu-header__button-icon" aria-label="Menú">
